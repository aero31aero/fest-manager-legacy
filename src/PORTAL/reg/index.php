...
<nav>
 <ul class="navigbar">
  ...
  <li><a href="dailyexcel.php" target="_blank">Generate Daily Excel</a></li>
...
<div class="container">
  ...
  <div class="form-group field-wrap">
   ...
   <div class="form-group field-wrap">
    ...
    <div class=" col-sm-offset-1 col-sm-9">
      <input type="email" class="form-control" id="valemail"name="email" required placeholder="Email">
    </div>
  </div>
  <div class="form-group field-wrap">
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      if(data[0]=='!')
      {
        $("#myModal .modal-title").html("Registration Failed!!");
         $("#myModal .modal-body").html(data.substring(1));
      }
      else if(data[0]=='#')
      {
        $("#myModal .modal-title").html("Registration Failed!!");
      ...
      {
          $("#myModal .modal-title").html("Registration Successfull!!");
      }
      $("#myModal").modal("show");         
      $("#myModal").on('hide.bs.modal', function () {          
            ...
            $('#valphone').attr('value','');
            $('.reg-o-checkbox').attr('checked',false);
            $('.accom-o-checkbox').attr('checked',false);
            $('.reg-checkbox').attr('checked',false);       
            $('.accom-checkbox').attr('checked',false);
            $('#name').val('');
            $('#email').val('');
            $('#pearl_id').val('');
            $('#college').val('');
  ...
  $('.check_details').click(function(){
    ...
    if(detail==''){
      $("#myModal .modal-body").html("Please Fill All Fields");
  ...
  $('.registeronline').click(function(){
    ...
    else if(pearl_id.substring(0,3)!='PLH'||pearl_id.length!=7)
    {
      $("#myModal .modal-body").html("Wrong Pearl ID Format");
      $("#myModal .modal-title").html("Error");
      $("#myModal").modal("show");    
    }
      else{
